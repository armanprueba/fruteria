...
class FrutasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $imagenes = [
            ...
            'Sandía' => 'https://static.vecteezy.com/system/resources/previews/029/200/216/non_2x/watermelon-transparent-background-free-png.png',
        ...
        for($i=0;$i<=5;$i++){
            ...
            $fruta->precio= $faker->numberBetween($min = 1,5, $max = 4,2);
